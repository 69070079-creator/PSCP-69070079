...
```text
Input:
โปรแกรมรับจำนวนเต็ม n และเครื่องหมาย n ค่า

Output:
ถ้าเครื่องหมาย "+"  คะแนน +10 ถ้าเครื่องหมาย"-" คะแนน -5
...
Step 2: ลูป n ครั้งเพื่อรับค่าเครื่องหมาย
Step 3: ถ้า "+" score += 10
Step 4: ถ้าไ "-" score -= 5
```
...
```text
เหมือนกับแผนแรก คือตรวจว่าเป็นเครื่องหมายอะไร แล้วเพิ่มทคะแนนตามเงื่อนไขของเครื่องหมายที่ input เข้ามา
```
...
```text
ตรวจสอบว่าโปรแกรมทำงานถูกต้องไหม
```
