...
```text
โจทย์ให้นำค่าจำนวนเต็ม ไปหาค่าบริการและvat และพิมพ์ผลรวมของทั้ง 3 ค่า
Input:
รับจำนวนเต็ม 1 ค่า

Output:
พิมพ์จำนวนเงินที่ลูกค้าต้องจ่ายหลังจากได้รวมค่าบริการและ VAT 7%

Constraints:
โจทย์บอกว่าค่าบริการจะคิดอย่างน้อย 50 บาท แต่จะไม่เกิน 1000 บาท เพราะงั้นควรคิดเงื่อนไขที่มีจำนวนที่ออกนอกขอบเขตนี้
```
...
Step 2: นำไป * 0.10 เพื่อหาค่าบริการ
Step 3: ถ้าน้อยกว่า 50 ให้ค่าบริการ = 50 ถ้ามากกว่า 1000 ให้ค่าบริการ = 1000
Step 4: นำค่า(จำนวนเต็ม + ค่าบริการ) * 0.07 เพื่อหาค่า vat 7%
Step 5: พิมพ์ผมรวมของค่าจำนวนเต็ม ค่าบริการ และค่าvat 
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก นำค่าจำนวนเต็มไปหาค่าบริการ แล้วนำผลรวมของทั้ง 2 ไปหาค่า vat แล้วพิมพ์ผลรวมของค่าทั้งสาม
```
...
```text
เพราะเวลานำไปคำนวน ค่าบริการต่ำกว่า 50 
```
...
```text
เพราะเวลานำไปคำนวน ค่าบริการมากกว่า 1000
```
...
```text
เพราะเวลานำไปคำนวน ค่าบริการอยู่ในช่วง 50 <= x <= 1000
```
