...
```text
ให้คำนวนหายอดที่ต้องจ่าย จากกว่าเช็ดว่าเป็นสมาชิกสหกรณ์ไหม 
Input:
รับค่าข้อความ(Y/N) ว่าเป็นสมาชิกไหม 1 บรรทัด
รับจำนวนเต็ม n 1 บรรทัด
รับค่าจำนวนเต็ม  n บรรทัด
Output:
ยอดที่ต้องจ่าย

Constraints:
output ต้องปัดเศษขึ้นเหลือ 2 ต่ำแหน่ง
```
...
```text
Step 1: import math
Step 2: รับค่าข้อความ(Y/N) 
รับจำนวนเต็ม n 1 บรรทัด
Step 3: รับค่าจำนวนเต็ม โดยใช้loop in range(n)
Step 4: นำค่าที่รับมา + กัน
Step 5: ตรวจว่าเป็นสมาชิกสหกรณ์ไหม
Step 6: ถ้าจริง ลด 5%
Step 7:ถ้าไม่จริงแต่ซื้อ >= 500 ลด 3%
Step 8:ใช้math.ceil(ค่าที่คำนวนมา * 100) / 100
Step 9:พิมพ์ค่าที่ได้
```
...
```text
ไม่เหมือน เปลี่ยนจากการ import math เพื่อใช้ math.ceil เป็น import decimal เพื่อใช้ decimal.Decimal เพื่อปัดเศษแทนเพราะ เพื่อนบอกว่ามันมีความแม่นยำมากกว่า
```
...
```text
ถ้ารับทศนิยมจะปัดเศษถูกต้องไหม
```
...
```text
ช่วยแนะนำการใช้ from decimal import Decimal
```

คุณยังทำอะไรด้วยตนเอง

```text
ผมเขียนวิธีการปัดเศษด้วยตัวเอง
```
