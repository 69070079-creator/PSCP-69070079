...
```text
Input:
รับค่าขนาดแถมคือ L และ ช่องสุดท้ายที่ไปถึงคือ N

Output:
แถบที่ช่องสุดท้ายอยู่

Constraints:
ขนาดแทบแนวทแยงจะเพิ่มขึ้นที่ละ 1
```
...
```text
Step 1: รับค่าโดยใช้map
Step 2: กำหนดขนาดแถบเริ่มต้น = 0 
Step 3: กำหนดเส้นทแยงมุม  = 1
Step 4: ใช้ลูปหาว่า n อยู่เส้นทแยงที่เท่าไหร่
Step 5: เข้าสูตร (เส้นทแยงมุม + ขนาดแถบ - 1) // ขนาดแถบ
```
...
```text
เหมือนแผนจริง แต่ใส่เงื่อนไข ถ้าช่องปัจจุบัน >= n ให้ break
```
