...
```text
https://ijudge.it.kmitl.ac.th/submissions/591654/overview
```
...
```text
Input:
โปรแกรมรับจำนวนเต็ม 3 ค่า  n ,k,t

Output:
พิมพ์จำนวนครั้งที่ส่งของขวัญ

Constraints:
ถ้าของขวัญกลับมาที่ต่ำแหน่งที่ 1 หรือไปตกที่ t ให้หยุดการส่งของขวัญ
```
...
```text
Step 1: จำนวนคนทั้งหมด n วนที่ละ k โจรคือคนที่ t
Step 2: ใช้ลูปหาต่ำแหน่งปัจจุบันของของขวัญ และจำนวนครั้งที่ส่งของขวัญ
Step 3: ถ้าต่ำแหน่ง == t หยุดการลูป
Step 4: คำนวนหาต่ำแหน่งปัจจุบัน
Step 5: ถ้าต่ำแหน่ง == 1 หยุดการลูป
```
...
```text
เหมือนแผนแรก ใช้ลูปหาต่ำแหน่งและจำนวนครั้งที่ส่งของขวัญ
```
