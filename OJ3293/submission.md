...
Output:
พิมพ์ข้อความ 7 บรรทัดโดยบรรทัดแรกกับสุดท้าย และตัวแรกสุดกับท้ายสุดของบรรทัดเป็น "*" โดยข้างในกรอบ"*" พิมพ์ input ที่รับเข้ามา

Constraints:
ถ้่าเป็นบรรทัดว่าง output ต้องว่างเหมือนกัน
```
...
```text
Step 1: สร้างlist
Step 2: นำ input ที่รับมาเข้า list
Step 3: ใช้ลูปหาขนาดข้อความที่ยาวที่สุด
Step 4: นำค่าที่ได้มา + 4 แล้วคูณ "*" เพื่อพิมพ์ขอบบนล่าง
Step 5: ใช้ลูปเพื่อพิมพ์ข้อความในlist
```
...
```text
เหมือนแผนแรกแต่ใช้ .ljust เพื่อให้ข้อความแต่ละบรรทัดยาวเท่ากัน
```
