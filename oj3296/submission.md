...
```text
Step 1: รับค่าสี r g b 2 บรรทัด
Step 2: นำค่าสีเดียวกันมา +  กันหาร 2 
Step 3: พิมพ์ค่าที่ได้
```
...
```text
เหมือนแผนแรกแต่เปลี่ยนเป็นสร้างฟังก์ชันแยก เพราะอยากทำ
```
