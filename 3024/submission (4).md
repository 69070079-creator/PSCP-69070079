...
```text
โจทย์ให้เรารับค่าจำนวน 2 ค่า คือผลรวม(3คน)กับค่าสูงสุด  เพื่อหาผลต่างของสูงสุดและต่ำสุดมาเข้าเงื่อนไขแล้วพิมพ์ข้อความตามที่กำหนด
Input:
โปรแกรมรับจำนวนเต็ม 2 บรรทัด
ผลรวม(3 คน)
ค่าสูงสุด
Output:
ถ้าผลต่างของสูงสุดและต่ำสุด > 2 พิมพ์ Surprising
ถ้าไม่พิมพ์ Not surprising

Constraints:
จากโจทย์ค่าที่รับเข้ามาจะต่ำสุดที่ 0 มากที่สุดที่ 10 
```
...
```text
Step 1: อ่านค่า 2 บรรทัด a(ผลรวม) และ b(ค่ามากสุด)
Step 2: หาค่าน้อยสุด c(ค่าน้อยสุด) = a - 2b
Step 3: ถ้า b - c > 2 พิมพ์ Surprising 
Step 4: ถ้าไม่พิมพ์ Not surprising
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก นำค่าที่รับมามาคำนวนหาค่าน้อยสุด c = a - 2b แล้วไปเช็ดในเงื่อนไข ถ้าใช้พิมพ์ Surprising ถ้าไม่ใช่พิมพ์ Not surprising
```
