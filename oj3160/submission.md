...
```text
https://ijudge.it.kmitl.ac.th/submissions/592850/overview
```
...
Output:
พิมพ์จำนวนเฉพาะที่อยู่ในช่วงของ input และอีกบรรทัดพิมพ์ "Total primes:" จำนวนจำนวนเฉพาะที่อยู่ในช่วง

Constraints:
ช่วงของจำนวนเฉพาะให้เอาตัวท้ายมาด้วย
```
...
```text
Step 1: อ่านจำนวนเต็ม 2 ค่า num1 num2
Step 2:ลูปในช่วง (num1,num2 + 1)
Step 3: ใช้อีกลูปเพื่อเช็ดว่าเป็นจำนวนเฉพาะไหม
Step 4: ถ้าใช้เกฺ็บไว้ในlist
```
...
```text
เหมือนวิธีแรก คือใช้บลูปในการหาแต่ต่างตรงที่จากการใช้ลูปซ้อนลูปเปลี่ยนเป็นสร้างฟังก์ชันแยกแทน เพราะอ่านง่ายกว่้า
```
