...
```text
คำนวนหาจำนวนอิฐก้อนเล็กที่ใช้สร้างสะพาน
Input:
รับค่าอิฐเล็ก a ก้อน
รับค่าอิฐใหญ่ b ก้อน
รับค่าความยาวสะพาน goal นิ้ว

Output:
พิมพ์ จำนวนอิฐก้อนเล็กที่ต้องใช้ (ถ้าสร้างได้)
พิมพ์ -1 ถ้าอิฐไม่พอสร้าง

Constraints:
โจทย์บอกว่าต้องสร้างให้พอดีกับ goal นิ้ว โดยต้องใช้ก้อนใหญ่ให้เยอะที่สุดเท่าที่เป็นไปได้
...
```text
Step 1: อ่านจำนวนเต็ม 3 บรรทัด a,b,goal
Step 2: ใช้ min(b, goal // 5) เพื่อตรวจว่าใช้ก้อนใหญ่ได้สูงสุดกี่ก้อน
Step 3: นำ goal - จำนวนอิฐก้อนใหญ่ * 5
Step 4: ถ้าค่าที่ได้น้อยกว่าหรือเท่ากับค่า a พิมพ์ค่าที่หาได้ใน Step 3
Step 5: ถ้าไม่พิมพ์ -1
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก หาก้อนใหญ่ที่จะใช้ก่อนแล้วไปลบการความยาวสะพาน หลังจากนั้นไปตรวจสอบเงื่อนไขว่าค่าที่ได้ <= อิฐก้อนเล็กไหม ถ้าใช้พิมพ์ค่าที่ได้ ถ้าไม่พิมพ์ -1
```
...
```text
ถ้าอิฐก้อนใหญ่พอดีกับความยาวสะพาน
```
