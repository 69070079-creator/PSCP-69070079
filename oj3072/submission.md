...
นับจำนวนสระ
Input:
รับ]ค่าข้อความ 1 ค่า

Output:
พิมพ์สระที่นับได้
Constraints:
ตัวเล็กและตัวใหญ่ ถือว่าเป็นตัวเดียวกัน เลยต้องใช้.lower
```
...
```text
Step 1: รับข้อความ.lower
Step 2: สร้างตัวแปรเก็บสระ "aeiou"
Step 3:  ใช้for i in text เพื่อนับสระ
Step 4: ใช้for i in ตัวแปร เพื่อดูว่าสระอะไร
Step 5: พิมพ์สระที่นับได้
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ใช้ลูปแรกนับสระเพิ่มเข้าไปในlist แล้วใช้ลูปที่สองเช็ดว่าคือสระอะไร
```
